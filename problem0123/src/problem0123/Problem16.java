...
public class Problem16 {
	...
	public static boolean isTwoAndFiveAndEightMultiple (int num) {
		// 2, 5, 8의 배수일 경우 true 반환
	...
	public static void main(String[] args) {
		...
		System.out.println("===========================================");
		System.out.println("2, 5, 8의 배수인 값을 출력합니다.");
		if(isTwoAndFiveAndEightMultiple(num1)) {
			System.out.println("num1값("+num1+")은 위 조건에 해당합니다.");
		}
		if(isTwoAndFiveAndEightMultiple(num2)) {
			System.out.println("num2값("+num2+")은 위 조건에 해당합니다.");
		}
		if(isTwoAndFiveAndEightMultiple(num3)) {
			System.out.println("num3값("+num3+")은 위 조건에 해당합니다.");
		}
		if(isTwoAndFiveAndEightMultiple(num4)) {
			System.out.println("num4값("+num4+")은 위 조건에 해당합니다.");
		}
		if(isTwoAndFiveAndEightMultiple(num5)) {
			System.out.println("num5값("+num5+")은 위 조건에 해당합니다.");
		}
		if(!isTwoAndFiveAndEightMultiple(num1) 
				&& !isTwoAndFiveAndEightMultiple(num2) 
				&& !isTwoAndFiveAndEightMultiple(num3) 
				&& !isTwoAndFiveAndEightMultiple(num4) 
				&& !isTwoAndFiveAndEightMultiple(num5)) 
		{
